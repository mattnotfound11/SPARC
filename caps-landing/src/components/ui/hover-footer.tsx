  ...
  return (
    ...
    >
      ...
      <motion.text
        ...
        dominantBaseline="middle"
        strokeWidth="0.3"
        className="fill-transparent stroke-[#CC1B2B] font-[helvetica] text-8xl font-bold 
        dark:stroke-[#CC1B2B99]"
...
export const FooterBackgroundGradient = () => {
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(125% 125% at 50% 10%, #0F0F1166 50%, #CC1B2B33 100%)",
      }}
    />
  );
};
