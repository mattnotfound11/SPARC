...
export function LandingHeader() {
  return (
    <header className="fade-in sticky top-3 z-40 px-4 pt-3 sm:px-6">
      <nav
        aria-label="Primary"
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/login"
            className="btn btn-outline rounded-lg border border-line-strong bg-white/[0.03] px-3.5 py-2 text-[0.8125rem] font-semibold text-ink"
          >
            Log In
          </Link>
          <Link
            href="/signup"
            className="btn btn-gold gold-glow rounded-lg bg-gold px-3.5 py-2 text-[0.8125rem] font-semibold text-on-gold"
          >
            Register Vehicle
          </Link>
        </div>
